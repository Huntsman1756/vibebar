...
export const demoSnapshot: DashboardSnapshot = {
  ...
  usageHistory: {
    rows: [
      ...
      { day: "2026-08-15", repository: "github.com/example/alpha", agent: "executor", provider: "nan", model: "deepseek-v4-flash", source: "opencode-db-messages-31d", sourceFidelity: "metadata", messageCount: 8, sessionCount: 2, tokens: { inputTokens: 4_000_000, outputTokens: 280_000, cacheReadTokens: 8_400_000, cacheWriteTokens: 0 }, costMicrousd: 188_000 },
      ...
      { day: "2026-08-05", repository: "github.com/example/alpha", agent: "executor", provider: "nan", model: "qwen3.6", source: "opencode-db-messages-31d", sourceFidelity: "metadata", messageCount: 4, sessionCount: 1, tokens: { inputTokens: 2_100_000, outputTokens: 160_000, cacheReadTokens: 4_600_000, cacheWriteTokens: 0 }, costMicrousd: 76_000 },
      { day: "2026-08-01", repository: "github.com/example/gamma", agent: "planner", provider: "nan", model: "mimo-v2.5", source: "opencode-db-messages-31d", sourceFidelity: "metadata", messageCount: 3, sessionCount: 1, tokens: { inputTokens: 780_000, outputTokens: 66_000, cacheReadTokens: 900_000, cacheWriteTokens: 0 }, costMicrousd: 28_000 },
      ...
      { day: "2026-07-18", repository: "local/sandbox", agent: "assistant", provider: "custom-provider", model: "glm5.2", source: "vibebar-events-31d", sourceFidelity: "event-fallback", messageCount: 0, sessionCount: 0, tokens: { inputTokens: 520_000, outputTokens: 40_000, cacheReadTokens: 0, cacheWriteTokens: 0 }, costMicrousd: null },
    ],
